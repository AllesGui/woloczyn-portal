...
export default function LandingInsalubridade() {
    ...
    return (
        <div className="min-h-screen bg-[#F3F4F6] font-inter text-slate-800 flex flex-col">
            {/* Header Section */}
            <div className="relative w-full overflow-hidden bg-white border-b border-slate-200">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 pt-16 pb-12 md:pt-24 md:pb-16 flex flex-col items-start text-left">
                    <h1 className="text-4xl md:text-5xl lg:text-5xl font-serif text-[#111827] mb-4 drop-shadow-sm leading-tight">
                    ...
                    <p className="text-base md:text-lg text-slate-600 mb-8 max-w-xl leading-relaxed font-light">
                        Quem trabalha com <strong className="text-[#1E3A8A] font-medium">limpeza de banheiros ou coleta de lixo</strong> têm direito a receber o adicional de <strong className="text-[#1E3A8A] font-medium">40% de insalubridade.</strong>
                    </p>
            ...
            <div className="w-full bg-[#111827] text-slate-100 pt-10 pb-4 md:pb-6 z-10 px-4 md:px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    {/* The Card */}
                    <div className="bg-[#1F2937] rounded-3xl p-6 md:p-10 shadow-2xl mb-8 border border-slate-700">
                        <ul className="space-y-5">
                            <li className="flex items-start gap-4">
                                <div className="mt-1 bg-[#1E3A8A] rounded-full p-1 shrink-0 shadow-sm border border-[#3B82F6]/30">
                    ...
                    <div className="text-center mb-2 mt-8">
                        <p className="text-lg md:text-xl text-slate-300 font-medium leading-relaxed mb-8">
                            Se marcou 1 ou mais itens, <strong className="text-white">vale a pena analisar seu caso.</strong> <br className="hidden md:block" />
                            <span className="text-[#EED789] block mt-4 text-xl md:text-2xl font-bold">
            ...
            <div className="w-full bg-[#1F2937] pt-8 pb-16 px-6 relative border-t border-slate-700">
