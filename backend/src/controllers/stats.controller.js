    ...
    try {
        ...
        return res.json({
            summary: {
                ...
                avgResponseHours: parseFloat(parseFloat(avgTimeResult.rows[0].avg_hours || 0).toFixed(1)) || 0,
                potentialValue: parseFloat(potentialResult.rows[0].total_potential || 0) || 0,
            },
